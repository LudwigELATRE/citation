...
let citations = [
  ...
  [
    "Le cœur a ses raisons que la raison ne connaît point.Le silence éternel de ces espaces infinis m’effraie.Cependant le monde est si inquiet, qu’on ne pense presque jamais à la vie présente et à l’instant où l’on vit, mais à celui où l’on vivra. De sorte qu’on est toujours en état de vivre à l’avenir, et jamais de vivre maintenant.",
    "Blaise Pascal",
  ],
];
...
// let nombreAleatoire = Math.floor(Math.random() * 20);
let nombreAleatoire = genererNombreEntier();
